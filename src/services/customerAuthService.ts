...
Promise<ApiResponse<customerType.CustomerLoginResult>> => {
    const response = await customerAxiosClient.post<ApiResponse<customerType.CustomerLoginResult>>
...
Promise<ApiResponse<customerType.CustomerResponseData>> => {
    const response = await customerAxiosClient.post<ApiResponse<customerType.CustomerResponseData>>
...
export const getCustomerProfile = async (): Promise<ApiResponse<customerType.CustomerResponseData>> => {
    const response = await customerAxiosClient.get<ApiResponse<customerType.CustomerResponseData>>
...
Promise<ApiResponse<customerType.CustomerResponseData>> => {
    const response = await customerAxiosClient.put<ApiResponse<customerType.CustomerResponseData>>
...
Promise<ApiResponse<customerType.UpdateCustomerProfileImageResult>> => {
    ...
    const response = await customerAxiosClient.patch<ApiResponse<customerType.UpdateCustomerProfileImageResult>>(
...
Promise<ApiMessageResponse> => {
    const response = await customerAxiosClient.post<ApiMessageResponse>
